...
head:
  ...
  - - meta
    - name: keywords
      content: generative audio workstation, GAW, AI music, live performance, music generation, MIDI generation, Gemini, Lyria, Stable Audio, electronic music, contract-based composing, plugin SDK, creative control, AI music layers, compose AI music, prompt to layer
home: true
actions:
  - text: Mac (Silicon)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_53_0-arm64.dmg
    type: primary
  - text: Mac (Intel)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_53_0-x64.dmg
    type: secondary
