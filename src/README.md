...
actions:
  - text: Mac (Silicon)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-3_6_0-arm64.dmg
    type: primary
  - text: Mac (Intel)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-3_6_0-x64.dmg
    type: secondary
