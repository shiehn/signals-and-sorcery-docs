...
actions:
  - text: Mac (Silicon)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_28_0-arm64.dmg
    type: primary
  - text: Mac (Intel)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_28_0-x64.dmg
    type: secondary
