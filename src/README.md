...
head:
  - - meta
    - name: description
      content: Signals & Sorcery - A Generative Audio Workstation (GAW) for contract-based composing with Gemini MIDI and Lyria audio generation. Preview in headphones, perform to audience. Free to try, no credit card required.
  - - meta
    - name: keywords
...
actions:
  - text: Mac (Silicon)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_46_0-arm64.dmg
    type: primary
  - text: Mac (Intel)
    link: https://storage.googleapis.com/docs-assets/signals-and-sorcery-2_46_0-x64.dmg
    type: secondary
