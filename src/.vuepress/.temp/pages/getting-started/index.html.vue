<template><div><h2 id="how-do-i-use-it" tabindex="-1"><a class="header-anchor" href="#how-do-i-use-it" aria-hidden="true">#</a> How do I use it?</h2>
<ol>
<li>Download the plugin installer. Run it.</li>
<li>Open <a href="Ableton">https://www.ableton.com/</a>.  Find the plugin in Ableton's plugin menu: <code v-pre>Plugin-Ins -&gt; SignalsAndSorcery -&gt; DAWNet.vst3</code>.  (If you don't see the plugin go to <code v-pre>options -&gt; preferences -&gt; &quot;Use VST3 plugin system folder&quot; -&gt; rescan</code>)</li>
<li>Open the plugin.  The home view of the plugin lists remade Google Colabs.  Click on a Colab to open it.</li>
<li>From the plugin copy the &quot;token&quot; from top right of DAWNet VST interface.</li>
