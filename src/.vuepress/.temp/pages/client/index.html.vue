<template><div><h1 id="python-client" tabindex="-1"><a class="header-anchor" href="#python-client" aria-hidden="true">#</a> Python Client</h1>
<h2 id="what-is-it" tabindex="-1"><a class="header-anchor" href="#what-is-it" aria-hidden="true">#</a> What is it?</h2>
<p>The <code v-pre>DAWNet client</code> is a python3 pip package.  It is used to create <code v-pre>DAWNet remotes</code>.  Remotes are scripts created with the python client.  The client allows a user to register remote functions with the DAWNet discovery server. After a function has been registered it can then be triggered remotely from `DAWNet plugin.</p>
<div class="custom-container warning"><p class="custom-container-title">WARNING</p>
<p>NOTE: The plugin is in an active, pre-alpha state.  It has only been tested on Ableton 11 on MAC M1.</p>
</div>
