...
export default {
    ...
    description: 'Generative Audio Workstation (GAW) for contract-based composing. Generate infinite MIDI and audio layers within your contract and compose with them — full creative control, not one-shot song generation. Gemini MIDI, Lyria audio.',
    ...
    head: [
        ...
        // SEO meta tags
        ['meta', { name: 'keywords', content: 'generative audio workstation, GAW, AI music, live performance, music generation, MIDI generation, Gemini, Lyria, contract-based composing, plugin SDK, electronic music, Tracktion Engine, creative control, AI music layers, compose AI music, prompt to layer' }],
