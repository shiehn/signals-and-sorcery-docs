---
sidebar: auto
title: Automating Signals & Sorcery
---

# Automating Signals & Sorcery

Signals & Sorcery ships with a public programmatic surface, the same one the
in-app assistant uses. Anything the app can do, an agent (Claude Code, OpenClaw,
...
3. **Skip the CLI entirely** and call the local HTTP API directly:
   ```bash
